...
def get_config():
    ...
    C.resume_path = '/mnt/petrelfs/linweixiong/num_rep/minGPT/projects/adder/out/multi_xval/model.pt'
...
class MultipDataset(Dataset):
    ...
    def __init__(self, config, split):
        ...
        torch.manual_seed(0)  # NOTE 这样 torch.rand 出现的结果就被固定下来了
